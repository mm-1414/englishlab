...
st.markdown("#### 解答や解説を保存したい場合は、メールアドレスを入力してください。")
email = st.text_input("メールアドレスを入力してください(任意)")
...
"""
            ...
            log_data = pd.DataFrame([[timestamp, name, email]], columns=["日時", "名前", "メールアドレス"])
