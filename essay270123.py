...
3. 文法・語法・単語・表現に間違いや不適切な点があれば、すべて丁寧に指摘してください。
   【ミス箇所】→【どのように間違っているか】→【なぜ間違いか(ルールや理由)】→【正しい例】の順で、1つ1つ詳しく説明してください。
   小さなミス(冠詞、単数複数、時制、語順)も漏らさず指摘してください。
4. First, Second, In conclusionなどの論理的接続表現が適切に使われているかを必ずチェックしてください。
   接続表現が使われていない場合は「接続表現が不足しています」と必ず明記し、どのような接続詞をどこに使えばよいか具体的に示してください。
5. 100語程度の模範解答を英語で示してください。

※すべての解説は日本語(です・ます調)で、やさしく詳しく書いてください。
